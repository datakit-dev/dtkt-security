...
You can find more information about DataKit and our security practices at [withdatakit.com/security](https://withdatakit.com/security).
...
To securely use the DataKit CLI, follow these best practices:
...
grype artifact
# or (more efficiently)
grype sbom:artifact.spdx.sbom.json
```
